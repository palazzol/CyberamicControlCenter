   ...
   1358 10 20 40 80         548         .byte   0x10,0x20,0x40,0x80
                            549 ;
                            550 ; This table is referenced by UART code
   135C 4D 31               551         .byte   0x4D,0x31                               ; M1
   135E 4D 32               552         .byte   0x4D,0x32                               ; M2
                            553 ;
                            554 ;       Read the AGC mic level
                            555 ;       Take the average of 8 samples, and put it into AGC_LEVEL (range is 0 to 8)
                            556 ;
   1360                     557 L1360:
   1360 A9 00         [ 2]  558         lda     #0x00
   1362 85 60         [ 3]  559         sta     0x60
   1364 85 61         [ 3]  560         sta     0x61
   1366 A9 0A         [ 2]  561         lda     #0x0A
   1368 85 54         [ 3]  562         sta     0x54
   136A A9 64         [ 2]  563         lda     #0x64
   136C 85 53         [ 3]  564         sta     0x53
   136E                     565 L136E:
   136E 20 ED 13      [ 6]  566         jsr     L13ED
   1371 A5 54         [ 3]  567         lda     0x54
   1373 D0 F9         [ 4]  568         bne     L136E
   1375 A9 0A         [ 2]  569         lda     #0x0A
   1377 85 54         [ 3]  570         sta     0x54
   1379 A9 64         [ 2]  571         lda     #0x64
   137B 85 53         [ 3]  572         sta     0x53
   137D A5 61         [ 3]  573         lda     0x61
   137F C9 08         [ 2]  574         cmp     #0x08
   1381 F0 15         [ 4]  575         beq     L1398
   1383 E6 61         [ 5]  576         inc     0x61
   1385 A2 09         [ 2]  577         ldx     #0x09
   1387 38            [ 2]  578         sec
   1388 AD 80 03      [ 4]  579         lda     audio_periph$ddr_reg_a
   138B                     580 L138B:
   138B 2A            [ 2]  581         rol
   138C CA            [ 2]  582         dex
   138D 90 FC         [ 4]  583         bcc     L138B
   138F 18            [ 2]  584         clc
   1390 8A            [ 2]  585         txa
   1391 65 60         [ 3]  586         adc     0x60
   1393 85 60         [ 3]  587         sta     0x60
   1395 4C 6E 13      [ 3]  588         jmp     L136E
                            589 ;
   1398                     590 L1398:
   1398 46 60         [ 5]  591         lsr     0x60
   139A 46 60         [ 5]  592         lsr     0x60
   139C 46 60         [ 5]  593         lsr     0x60
   139E A5 60         [ 3]  594         lda     0x60
   13A0 85 5F         [ 3]  595         sta     0x5F
   13A2 A9 00         [ 2]  596         lda     #0x00
   13A4 85 60         [ 3]  597         sta     0x60
   13A6 85 61         [ 3]  598         sta     0x61
   13A8 60            [ 6]  599         rts
                            600 ;
                            601 ;        Do AGC Mic Logic
                            602 ;
   13A9                     603 L13A9:
   13A9 AD 80 02      [ 4]  604         lda     U19_PORTA
   13AC 49 FF         [ 2]  605         eor     #0xFF
   13AE 4A            [ 2]  606         lsr
   13AF 4A            [ 2]  607         lsr
   13B0 4A            [ 2]  608         lsr
   13B1 4A            [ 2]  609         lsr
   13B2 18            [ 2]  610         clc
   13B3 65 5F         [ 3]  611         adc     0x5F
   13B5 AA            [ 2]  612         tax
   13B6 BD DC 13      [ 5]  613         lda     AGCTABLE,x
   13B9 85 62         [ 3]  614         sta     0x62
   13BB A5 52         [ 3]  615         lda     0x52
   13BD D0 16         [ 4]  616         bne     L13D5
   13BF A9 0A         [ 2]  617         lda     #0x0A
   13C1 85 52         [ 3]  618         sta     0x52
   13C3 A5 62         [ 3]  619         lda     0x62
   13C5 CD 82 03      [ 4]  620         cmp     audio_periph$ddr_reg_b
   13C8 90 08         [ 4]  621         bcc     L13D2
   13CA F0 09         [ 4]  622         beq     L13D5
   13CC EE 82 03      [ 6]  623         inc     audio_periph$ddr_reg_b
   13CF 4C D5 13      [ 3]  624         jmp     L13D5
                            625 ;
   13D2                     626 L13D2:
   13D2 CE 82 03      [ 6]  627         dec     audio_periph$ddr_reg_b
   13D5                     628 L13D5:
   13D5 AD 82 03      [ 4]  629         lda     audio_periph$ddr_reg_b
   13D8 8D 82 02      [ 4]  630         sta     U19_PORTB
   13DB 60            [ 6]  631         rts
                            632 ;
                            633 ;       AGC table
                            634 ;
   13DC                     635 AGCTABLE:
   13DC 03 04 06 08         636         .db     0x03, 0x04, 0x06, 0x08
   13E0 10 16 20 2D         637         .db     0x10, 0x16, 0x20, 0x2D
   13E4 40 5A 80 BF         638         .db     0x40, 0x5A, 0x80, 0xBF
   13E8 FF FF FF FF         639         .db     0xFF, 0xFF, 0xFF, 0xFF
   13EC FF                  640         .db     0xFF
                            641 ;
                            642 ;       Process RAM_65 and RAM_66
                            643 ;
   13ED                     644 L13ED:
   13ED A5 65         [ 3]  645         lda     0x65
   13EF AA            [ 2]  646         tax
   13F0 A5 66         [ 3]  647         lda     0x66
   13F2 D0 37         [ 4]  648         bne     L142B
   13F4 BD 59 14      [ 5]  649         lda     X1459,x
   13F7 C9 FE         [ 2]  650         cmp     #0xFE
   13F9 F0 27         [ 4]  651         beq     L1422
   13FB C9 FF         [ 2]  652         cmp     #0xFF
   13FD D0 0B         [ 4]  653         bne     L140A
   13FF A9 00         [ 2]  654         lda     #0x00
   1401 85 65         [ 3]  655         sta     0x65
   1403 A9 FA         [ 2]  656         lda     #0xFA
   1405 85 64         [ 3]  657         sta     0x64
   1407 4C 21 14      [ 3]  658         jmp     L1421
                            659 
                            660 
   140A                     661 L140A:
   140A C5 64         [ 3]  662         cmp     0x64
   140C D0 13         [ 4]  663         bne     L1421
   140E BD 5A 14      [ 5]  664         lda     X1459+1,x
   1411 20 F6 12      [ 6]  665         jsr     L12F6
   1414 BD 5B 14      [ 5]  666         lda     X1459+2,x
   1417 20 F6 12      [ 6]  667         jsr     L12F6
   141A A5 65         [ 3]  668         lda     0x65
   141C 18            [ 2]  669         clc
   141D 69 03         [ 2]  670         adc     #0x03
   141F 85 65         [ 3]  671         sta     0x65
                            672 
   1421                     673 L1421:
   1421 60            [ 6]  674         rts
                            675 
   1422                     676 L1422:
   1422 E6 66         [ 5]  677         inc     0x66
   1424 A9 00         [ 2]  678         lda     #0x00
   1426 85 65         [ 3]  679         sta     0x65
   1428 4C 21 14      [ 3]  680         jmp     L1421
                            681 
   142B                     682 L142B:
   142B BD 43 15      [ 5]  683         lda     X1543,x
   142E C9 FF         [ 2]  684         cmp     #0xFF
   1430 D0 0D         [ 4]  685         bne     L143F
   1432 A9 00         [ 2]  686         lda     #0x00
   1434 85 65         [ 3]  687         sta     0x65
   1436 85 66         [ 3]  688         sta     0x66
   1438 A9 FA         [ 2]  689         lda     #0xFA
   143A 85 64         [ 3]  690         sta     0x64
   143C 4C 21 14      [ 3]  691         jmp     L1421
                            692 
   143F                     693 L143F:
   143F C5 64         [ 3]  694         cmp     0x64
   1441 D0 DE         [ 4]  695         bne     L1421
   1443 BD 44 15      [ 5]  696         lda     X1543+1,x
   1446 20 F6 12      [ 6]  697         jsr     L12F6
   1449 BD 45 15      [ 5]  698         lda     X1543+2,x
   144C 20 F6 12      [ 6]  699         jsr     L12F6
   144F A5 65         [ 3]  700         lda     0x65
   1451 18            [ 2]  701         clc
   1452 69 03         [ 2]  702         adc     #0x03
   1454 85 65         [ 3]  703         sta     0x65
   1456 4C 21 14      [ 3]  704         jmp     L1421
                            705 
   1459                     706 X1459:
   1459 F5 35 46 F5 35 46   707         .byte   0xF5,0x35,0x46, 0xF5,0x35,0x46, 0xEE,0x35,0x46, 0xEB,0x33,0x46 
        EE 35 46 EB 33 46
   1465 E9 32 46 E9 33 42   708         .byte   0xE9,0x32,0x46, 0xE9,0x33,0x42, 0xE8,0x33,0x46, 0xE7,0x32,0x46
        E8 33 46 E7 32 46
   1471 E6 33 46 E5 32 46   709         .byte   0xE6,0x33,0x46, 0xE5,0x32,0x46, 0xE4,0x33,0x46, 0xE3,0x32,0x46
        E4 33 46 E3 32 46
   147D E2 33 46 E1 32 46   710         .byte   0xE2,0x33,0x46, 0xE1,0x32,0x46, 0xE0,0x33,0x46, 0xDF,0x32,0x46
        E0 33 46 DF 32 46
   1489 DE 33 46 DD 32 46   711         .byte   0xDE,0x33,0x46, 0xDD,0x32,0x46, 0xDD,0x34,0x46, 0xDC,0x33,0x46
        DD 34 46 DC 33 46
   1495 DB 32 46 DB 35 46   712         .byte   0xDB,0x32,0x46, 0xDB,0x35,0x46, 0xDA,0x33,0x46, 0xD9,0x32,0x46
        DA 33 46 D9 32 46
   14A1 D1 32 42 C6 33 47   713         .byte   0xD1,0x32,0x42, 0xC6,0x33,0x47, 0xC6,0x33,0x43, 0xC5,0x32,0x47
        C6 33 43 C5 32 47
   14AD C3 34 46 C2 33 47   714         .byte   0xC3,0x34,0x46, 0xC2,0x33,0x47, 0xC1,0x32,0x47, 0xC0,0x35,0x46
        C1 32 47 C0 35 46
   14B9 B9 34 46 B9 32 43   715         .byte   0xB9,0x34,0x46, 0xB9,0x32,0x43, 0xB7,0x35,0x46, 0xB7,0x33,0x42
        B7 35 46 B7 33 42
   14C5 B3 33 46 B2 32 46   716         .byte   0xB3,0x33,0x46, 0xB2,0x32,0x46, 0xA8,0x32,0x42, 0x9D,0x33,0x47
        A8 32 42 9D 33 47
   14D1 9C 32 47 9B 33 47   717         .byte   0x9C,0x32,0x47, 0x9B,0x33,0x47, 0x9A,0x32,0x47, 0x9A,0x34,0x46
        9A 32 47 9A 34 46
   14DD 99 33 47 99 33 43   718         .byte   0x99,0x33,0x47, 0x99,0x33,0x43, 0x99,0x35,0x46, 0x98,0x32,0x47
        99 35 46 98 32 47
   14E9 97 33 47 94 32 47   719         .byte   0x97,0x33,0x47, 0x94,0x32,0x47, 0x93,0x33,0x47, 0x92,0x32,0x47
        93 33 47 92 32 47
