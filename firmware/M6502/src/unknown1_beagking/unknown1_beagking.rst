                             ...
                             18 ;
                             19 
                     0050    20 TIMER_1MS_A     = 0x0050    ; decremented every 1ms
                     0051    21 TIMER_1MS_B     = 0x0051    ; decremented every 1ms
                     0052    22 TIMER_1MS_C     = 0x0052    ; decremented every 1ms
                     0053    23 TIMER_1MS_R     = 0x0053    ; decremented every 1ms, resets to 100
                     0054    24 TIMER_100MS_A   = 0x0054    ; decremented every 0.1s
                     0055    25 TIMER_100MS_R   = 0x0055    ; decremented every 0.1s, resets to 100
                     0056    26 TIMER_10S       = 0x0056    ; decremented every 10s
                     0057    27 TIMER_TMP1      = 0x0057    ; temp timer storage
                     0058    28 ZEROCROSS_CTR   = 0x0058    ; zero crossing counter
                     0059    29 TRACK_CTR       = 0x0059    ; track counter
                     005A    30 PROG_CTR        = 0x005A    ; number of PROG button presses
                     005B    31 PROG_STATE      = 0x005B    ; 0x00=PROG was not pushed, 0x80=Prog was pushed
                     005C    32 TAPE_BYTE       = 0x005C    ; storage for incoming serial byte (& 0x7F)
                     005D    33 SOL_MASK        = 0x005D    ; bitmask for solenoids
                     005E    34 CURR_CHANNEL    = 0x005E    ; current channel serial byte
                     005F    35 TIMER_TMP       = 0x005F    ; temp timer storage
                     0060    36 AGC_LEVEL       = 0x0060    ; agc mic level
                     0061    37 AGC_ACCUM       = 0x0061    ; agc mic level accumulator
                     0062    38 AGC_SAMPLES     = 0x0062    ; agc mic sample counter
                     0063    39 AGC_GAIN        = 0x0063    ; agc calculated gain value
                     0064    40 CURR_PORT       = 0x0064    ; current channel port address
                             41 
   ...
   1C51 85 53         [ 3]   82         sta     TIMER_1MS_R                             ; 100 - init 1 msec master counter
   1C53 A9 1E         [ 2]   83         lda     #0x1E
   1C55 85 56         [ 3]   84         sta     TIMER_10S                               ; Init a 5 minute timer
   1C57 A9 64         [ 2]   85         lda     #0x64
   1C59 85 55         [ 3]   86         sta     TIMER_100MS_R                           ; 100 - init 0.1 sec master counter
   1C5B A9 10         [ 2]   87         lda     #0x10                                   ; 16
   1C5D 85 63         [ 3]   88         sta     AGC_GAIN                                ; Set initial AGC gain value
   ...
   1C7A 85 58         [ 3]  104         sta     ZEROCROSS_CTR                           ; counter to zero
   ...
   1C81 85 50         [ 3]  109         sta     TIMER_1MS_A                             ; set a 10ms timer
   1C83 E6 58         [ 5]  110         inc     ZEROCROSS_CTR                           ; inc transition counter
   1C85 A5 58         [ 3]  111         lda     ZEROCROSS_CTR
   ...
   1C8E A5 50         [ 3]  116         lda     TIMER_1MS_A
   ...
   1CA1 85 54         [ 3]  126         sta     TIMER_100MS_A                           ; 2.5 secs
   1CA3 A9 64         [ 2]  127         lda     #0x64
   1CA5 85 53         [ 3]  128         sta     TIMER_1MS_R
   1CA7                     129 $5:
   1CA7 20 83 1E      [ 6]  130         jsr     TUPDATE                                 ; do housekeeping stuff
   1CAA A5 54         [ 3]  131         lda     TIMER_100MS_A
   1CAC D0 F9         [ 4]  132         bne     $5
   1CAE A9 00         [ 2]  133         lda     #0x00
   1CB0 85 59         [ 3]  134         sta     TRACK_CTR
   ...
   1CBF 85 50         [ 3]  140         sta     TIMER_1MS_A
   1CC1                     141 $30:
   1CC1 20 83 1E      [ 6]  142         jsr     TUPDATE                                 ; housekeeping
   1CC4 A5 50         [ 3]  143         lda     TIMER_1MS_A
   ...
   1CD0 E6 59         [ 5]  148         inc     TRACK_CTR
   ...
   1CED A5 5A         [ 3]  162         lda     PROG_CTR                                ; wait until we are triggered
   ...
   1D16 C6 5A         [ 5]  183         dec     PROG_CTR                                ; no longer triggered
   1D18 20 D6 1D      [ 6]  184         jsr     PLAYTRK                                 ; play a track!
   1D1B 20 3F 1D      [ 6]  185         jsr     INITBRDS                                ; init the boards
   1D1E A9 1E         [ 2]  186         lda     #0x1E
   1D20 85 56         [ 3]  187         sta     TIMER_10S                               ; set a 5 min timer
   1D22 A9 64         [ 2]  188         lda     #0x64
   1D24 85 55         [ 3]  189         sta     TIMER_100MS_R
   1D26 E6 59         [ 5]  190         inc     TRACK_CTR                               ; track counter
   1D28 A5 59         [ 3]  191         lda     TRACK_CTR
   ...
   1D6D 85 5E         [ 3]  231         sta     CURR_CHANNEL                            ; reset current channel serial byte
   1D6F 85 64         [ 3]  232         sta     CURR_PORT                               ; reset current channel port address
   1D71 60            [ 6]  233         rts
                            234 ;
   ...
   1D77 85 50         [ 3]  241         sta     TIMER_1MS_A
   1D79                     242 $6:
   1D79 20 83 1E      [ 6]  243         jsr     TUPDATE                                 ; check for PROG button push
   1D7C A5 50         [ 3]  244         lda     TIMER_1MS_A
   ...
   1D8F 85 58         [ 3]  259         sta     ZEROCROSS_CTR
   1D91                     260 $8:
   1D91 AD 02 03      [ 4]  261         lda     transport_periph$ddr_reg_b
   1D94 A9 0A         [ 2]  262         lda     #0x0A
   1D96 85 50         [ 3]  263         sta     TIMER_1MS_A                             ; 10 msec
   1D98 E6 58         [ 5]  264         inc     ZEROCROSS_CTR
   1D9A A5 58         [ 3]  265         lda     ZEROCROSS_CTR
   ...
   1DA3 A5 50         [ 3]  270         lda     TIMER_1MS_A
   ...
   1DB2 85 50         [ 3]  284         sta     TIMER_1MS_A                             ; 250 msec
   1DB4                     285 $11:
   1DB4 20 83 1E      [ 6]  286         jsr     TUPDATE                                 ; housekeeping
   1DB7 A5 50         [ 3]  287         lda     TIMER_1MS_A
   ...
   1E1F 85 5C         [ 3]  351         sta     TAPE_BYTE                               ; store it here
   ...
   1E2F A5 5C         [ 3]  359         lda     TAPE_BYTE
   ...
   1E39 A6 64         [ 3]  364         ldx     CURR_PORT                               ; X = current board address
   ...
   1E4A 85 5D         [ 3]  375         sta     SOL_MASK                                ; store mask in SOL_MASK
   1E4C A5 5E         [ 3]  376         lda     CURR_CHANNEL
   1E4E 4A            [ 2]  377         lsr     a                                       ; get on/off in carry
   1E4F B0 09         [ 4]  378         bcs     $17                                     ; if on, jump
   1E51 A5 5D         [ 3]  379         lda     SOL_MASK
   ...
   1E59 60            [ 6]  383         rts
                            384 ;
   1E5A                     385 $17:
   1E5A A5 5D         [ 3]  386         lda     SOL_MASK
   1E5C 15 00         [ 4]  387         ora     RAM_start,x
   1E5E 95 00         [ 4]  388         sta     RAM_start,x                             ; turn on solenoid
   1E60 60            [ 6]  389         rts
                            390 ;
   1E61                     391 PROCCHNL:
   1E61 A5 5C         [ 3]  392         lda     TAPE_BYTE                               ; put channel byte in CURR_CHANNEL
   1E63 85 5E         [ 3]  393         sta     CURR_CHANNEL
   ...
   1E6D 85 64         [ 3]  398         sta     CURR_PORT                               ; set this to 0x98 - board 7
   1E6F 60            [ 6]  399         rts
                            400 ;
   1E70                     401 CONVCHNL:
   ...
   1E77 85 64         [ 3]  407         sta     CURR_PORT                               ; (X-0x32) * 2 + 0x80
   1E79 60            [ 6]  408         rts
   1E7A                     409 $18:
   1E7A 60            [ 6]  410         rts
                            411 ;
   ...
   1E7F 10 20 40 80         416         .db     0x10,0x20,0x40,0x80
                            ...
                            419 ;       TIMER_1MS_A used on entry
                            420 ;
   1E83                     421 TUPDATE:
   1E83 AD 05 02      [ 4]  422         lda     U18_edge_detect_control_DI_pos          ; Did the PROG button get pushed or timer expire?
   1E86 85 5F         [ 3]  423         sta     TIMER_TMP                               ; store this state in 5F
   1E88 F0 50         [ 4]  424         beq     TEXIT                                   ; No flags set, return
   1E8A A5 5B         [ 3]  425         lda     PROG_STATE                              ; Are we already running?
   1E8C 30 0E         [ 4]  426         bmi     $19                                     ; yes, jump ahead
   1E8E A5 5F         [ 3]  427         lda     TIMER_TMP                               ; else check flags
   1E90 29 40         [ 2]  428         and     #0x40                                   ; PROG pushed?
   1E92 F0 16         [ 4]  429         beq     ADJTMR                                  ; if not, go to adjust timer
   1E94 A9 80         [ 2]  430         lda     #0x80
   1E96 85 5B         [ 3]  431         sta     PROG_STATE                              ; PROG Button pushed
   1E98 A9 FA         [ 2]  432         lda     #0xFA
   1E9A 85 51         [ 3]  433         sta     TIMER_1MS_B
   1E9C                     434 $19:
   1E9C A5 51         [ 3]  435         lda     TIMER_1MS_B                             ; for 250ms?
   1E9E D0 06         [ 4]  436         bne     $20                                     ; no, exit
   1EA0 A9 00         [ 2]  437         lda     #0x00
   1EA2 85 5B         [ 3]  438         sta     PROG_STATE                              ; yes, reset PROG button state
   1EA4 E6 5A         [ 5]  439         inc     PROG_CTR                                ; and mark as running
   1EA6                     440 $20:
   1EA6 A5 5F         [ 3]  441         lda     TIMER_TMP                               ; check timer irq bit
   ...
   1EB0 4A            [ 2]  448         lsr     a
   1EB1 4A            [ 2]  449         lsr     a
   1EB2 85 57         [ 3]  450         sta     TIMER_TMP1                              ; store them
   1EB4 90 02         [ 4]  451         bcc     $21                                     ; bcc on timer bit D2
   1EB6 E6 57         [ 5]  452         inc     TIMER_TMP1                              ; round up?
                            453                                                         ; now TIMER_TMP1 has the number of 8us 
   ...
   1EBB E5 57         [ 3]  458         sbc     TIMER_TMP1
   1EBD 8D 15 02      [ 4]  459         sta     U18_timer_8T_DI                         ; set timer
   1EC0 C6 50         [ 5]  460         dec     TIMER_1MS_A                             ; decrement these timers every timer reset (1ms)
   1EC2 C6 51         [ 5]  461         dec     TIMER_1MS_B
   1EC4 C6 52         [ 5]  462         dec     TIMER_1MS_C
   1EC6 C6 53         [ 5]  463         dec     TIMER_1MS_R
   1EC8 D0 10         [ 4]  464         bne     TEXIT                                   ; if timer TIMER_1MS_R expires, then wrap to 100
   1ECA A9 64         [ 2]  465         lda     #0x64                                   ; 100
   1ECC 85 53         [ 3]  466         sta     TIMER_1MS_R
   1ECE C6 54         [ 5]  467         dec     TIMER_100MS_A
   1ED0 C6 55         [ 5]  468         dec     TIMER_100MS_R
   1ED2 D0 06         [ 4]  469         bne     TEXIT                                   ; if timer TIMER_100MS_R expires, then wrap to 100
   1ED4 A9 64         [ 2]  470         lda     #0x64                                   ; 100
   1ED6 85 55         [ 3]  471         sta     TIMER_100MS_R
   1ED8 C6 56         [ 5]  472         dec     TIMER_10S
   1EDA                     473 TEXIT:
   1EDA 60            [ 6]  474         rts
                            475 ;
                            476 ;       Read the AGC mic level
                            477 ;       Take the average of 8 samples, and put it into AGC_LEVEL (range is 0 to 8)
                            478 ;
   1EDB                     479 AGCMICRD:
   1EDB A9 00         [ 2]  480         lda     #0x00
   1EDD 85 61         [ 3]  481         sta     AGC_ACCUM                               ; init final agc value
   1EDF 85 62         [ 3]  482         sta     AGC_SAMPLES                             ; init agc sample counter
   1EE1 A9 0A         [ 2]  483         lda     #0x0A
   1EE3 85 54         [ 3]  484         sta     TIMER_100MS_A                           ; Start a 1 second timer
   1EE5 A9 64         [ 2]  485         lda     #0x64
   1EE7 85 53         [ 3]  486         sta     TIMER_1MS_R
   1EE9                     487 $23:
   1EE9 20 83 1E      [ 6]  488         jsr     TUPDATE                                 ; housekeeping
   1EEC A5 54         [ 3]  489         lda     TIMER_100MS_A
   1EEE D0 F9         [ 4]  490         bne     $23                                     ; if 1 sec, do housekeeping
   1EF0 A9 0A         [ 2]  491         lda     #0x0A
   1EF2 85 54         [ 3]  492         sta     TIMER_100MS_A
   1EF4 A9 64         [ 2]  493         lda     #0x64
   1EF6 85 53         [ 3]  494         sta     TIMER_1MS_R                             ; reset timer
   1EF8 A5 62         [ 3]  495         lda     AGC_SAMPLES
   1EFA C9 08         [ 2]  496         cmp     #0x08                                   ; 8 samples?
   1EFC F0 15         [ 4]  497         beq     $27                                     ; yes - jump to final calculation
   1EFE E6 62         [ 5]  498         inc     AGC_SAMPLES                             ; increment the sample counter
   ...
   1F0C 65 61         [ 3]  508         adc     AGC_ACCUM                               ; add it into AGC_ACCUM (do this 8 times)
   1F0E 85 61         [ 3]  509         sta     AGC_ACCUM
   1F10 4C E9 1E      [ 3]  510         jmp     $23
                            511 ;
   1F13                     512 $27:
   1F13 46 61         [ 5]  513         lsr     AGC_ACCUM                               ; divide by 8 (average of 8 samples)
   1F15 46 61         [ 5]  514         lsr     AGC_ACCUM
   1F17 46 61         [ 5]  515         lsr     AGC_ACCUM
   1F19 A5 61         [ 3]  516         lda     AGC_ACCUM
   1F1B 85 60         [ 3]  517         sta     AGC_LEVEL                               ; store agc value in AGC_LEVEL
   1F1D A9 00         [ 2]  518         lda     #0x00
   1F1F 85 61         [ 3]  519         sta     AGC_ACCUM                               ; clear these 2 and return
   1F21 85 62         [ 3]  520         sta     AGC_SAMPLES
   1F23 60            [ 6]  521         rts
                            522 ;
   ...
   1F2C 4A            [ 2]  531         lsr     a
   1F2D 18            [ 2]  532         clc
   1F2E 65 60         [ 3]  533         adc     AGC_LEVEL                               ; add audio level to it
   1F30 AA            [ 2]  534         tax
   1F31 BD 57 1F      [ 5]  535         lda     AGCTABLE,x                              ; and get the table value
   1F34 85 63         [ 3]  536         sta     AGC_GAIN                                ; store this value in AGC_GAIN
   1F36 A5 52         [ 3]  537         lda     TIMER_1MS_C                             ; 10ms timer expired?
   1F38 D0 16         [ 4]  538         bne     $26                                     ; no, just update CPU Leds
   1F3A A9 0A         [ 2]  539         lda     #0x0A
   1F3C 85 52         [ 3]  540         sta     TIMER_1MS_C                             ; restart 10ms timer
   1F3E A5 63         [ 3]  541         lda     AGC_GAIN                                ; every 10ms, adjust gain by 1 if needed
   ...
   1F6A 85 5A         [ 3]  568         sta     PROG_CTR                                ; clear pending PROG button presses
   1F6C 20 83 1E      [ 6]  569         jsr     TUPDATE                                 ; housekeeping
   1F6F 4C EA 1C      [ 3]  570         jmp     RETP1
                            571 ;
                            572 ; all zeros in this gap
                            573 ;
   1F72 00 00 00 00 00 00   574         .byte   0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00
        00 00 00 00 00 00
        00 00
   1F80 00 00 00 00 00 00   575         .byte   0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00        
        00 00 00 00 00 00
        00 00 00 00
   1F90 00 00 00 00 00 00   576         .byte   0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00        
        00 00 00 00 00 00
        00 00 00 00
   1FA0 00 00 00 00 00 00   577         .byte   0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00        
        00 00 00 00 00 00
        00 00 00 00
   1FB0 00 00 00 00 00 00   578         .byte   0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00        
        00 00 00 00 00 00
        00 00 00 00
   1FC0 00 00 00 00 00 00   579         .byte   0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00        
        00 00 00 00 00 00
        00 00 00 00
   1FD0 00 00 00 00 00 00   580         .byte   0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00        
        00 00 00 00 00 00
        00 00 00 00
   1FE0 00 00 00 00 00 00   581         .byte   0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00        
        00 00 00 00 00 00
        00 00 00 00
   1FF0 00 00 00 00 00 00   582         .byte   0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00        
        00 00 00 00
                            583 
   1FFA                     584         .org    0x1FFA
                            585 ;
                            ...
                            587 ;
   1FFA                     588 NMIVEC:
   1FFA 00 00               589         .dw     RAM_start
   1FFC                     590 RESETVEC:
   1FFC 00 1C               591         .dw     RESET
   1FFE                     592 IRQVEC:
   1FFE 00 00               593         .dw     RAM_start
                            594 
