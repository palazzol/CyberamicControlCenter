...
L1C8C:
        ...
        bpl     L1C9F                                   ; (> 83.333 Hz for 100 zero crossings)
...
L1CB7:
        ...
        lda     #0x00
        sta     RAM_59
        jsr     L1D83                                   ; wait for tone signaling beginning of track
        inc     RAM_59
        lda     #0x10
        jsr     L1D60                                   ; STOP tape
        lda     #0x80
...
L1D96:
        ...
        bpl     L1D96                                   ; if not, extend the looping
...
L1E72:
        ...
        beq     L1E99                                   ; if not, go to adjust timer
        lda     #0x80
