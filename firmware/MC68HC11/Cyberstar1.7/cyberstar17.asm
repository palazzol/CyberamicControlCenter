...
L80C1:
        ...
        ldaa    (0x0400)
        cmpa    #0x08
        beq     L811C           ; if 8, go directly to CPU test
        bcs     L8105           ; higher than 8, go to init setup, retaining L/R counts
        cmpa    #0x07
        beq     L8105           ; 7, go to init setup, retaining L/R counts
        ldd     #0x0000         ; 6 or lower...
